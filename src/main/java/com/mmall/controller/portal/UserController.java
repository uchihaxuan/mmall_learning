...
public class UserController {
    ...
    @RequestMapping(value = "forget_get_password.do", method = RequestMethod.POST)
    @ResponseBody
    ...
    public ServerResponse<User> getInformation(HttpSession session){
        User currentUser=(User) session.getAttribute(Const.CURRENT_USER);
        if(currentUser == null){
            return ServerResponse.createByErrorMessage(ResponseCode.NEED_LOGIN.getCode(),"未登录，需要强制登录");
        }
